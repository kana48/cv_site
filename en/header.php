<header>
  <?php
    echo '<a href="index.php?page=home&title=Hello">
    <img src="img/logo.png" alt="" class="logo">
         </a>';
  ?>

<?php 
    if(array_key_exists('fr', $_POST)) {
      changeLanguage('fr', $page);
    }
  ...
  <div class="h-left">
    ...
    <ul class="liens pc">
      <!-- Linkdin -->
      <li><a href="https://www.linkedin.com/in/kana-yamada-8b78a3188/?locale=en_US"><svg xmlns="http://www.w3.org/2000/svg"
