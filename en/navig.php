<div class="pc-menu">
  <nav class="menu">
    <ul>
      <li class="<?php echo($page == 'home')? 'active':'';?>"><a href="?page=home">Hello</a></li>
      <li class="<?php echo($page == 'profile')? 'active':'';?>"><a href="?page=profile">Profile</a></li>
      <li class="<?php echo($page == 'travaux')? 'active':'';?>"><a href="?page=travaux">Works</a></li>
...
<div class="overlay">
  ...
  <nav>
    <ul>
      ...
      <li><a href="?page=travaux">Works</a></li>
      <li><a href="?page=contact">Contact</a></li>
    </ul>

    <ul class="liens">
      <!-- Linkdin -->
      <li><a href="https://www.linkedin.com/in/kana-yamada-8b78a3188/?locale=en_US"><svg
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" stroke-width="3" stroke="#000000" fill="none"
            class="duration-300 transform transition-all" style="width: 48px; height: 48px;">
            <path
      ...
      <li>
        <form method="post">
          <input type="submit" name="fr" class="lang-btn" value="Français"/>
        </form>
      </li>
