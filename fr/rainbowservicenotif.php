...
<div class="gallery js-flickity"
  ...
  <img src="img/rainbow/1.png" alt="" class="travaux-single-img-horizontal gallery-cell">
  <img src="img/rainbow/2.png" alt="" class="travaux-single-img-horizontal gallery-cell">
  <img src="img/rainbow/3.png" alt="" class="travaux-single-img-horizontal gallery-cell">
  <img src="img/rainbow/4.png" alt="" class="travaux-single-img-horizontal gallery-cell">
  <img src="img/rainbow/5.png" alt="" class="travaux-single-img-horizontal gallery-cell">
...
<section class="travaux-single">
  ...
  <h4>Mon approche</h4>
  <p class=travaux-single-text>Concernant le design de cette fonctionnalité, j’ai fait un travail d’analyse sur le design de Rainbow et j’ai étudié son Design Kit actuel, afin de concevoir un système qui assure une cohérence visuelle avec l’application. Le développement est en cours et le lancement est prévu pour juin.
  </p>
  </div>
